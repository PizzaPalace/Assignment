...
public class SwipeFragmentThree extends Fragment {
    ...
    private OnFragmentThreeInteractionListner mListener;
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (OnFragmentThreeInteractionListner) activity;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        image3=(ImageView)view.findViewById(R.id.imageSwipe);
        temp=DataStorage.mImageData;
        planet= new ArrayList<Integer>();
        String planetname=mListener.getPlanetName();
        planet= temp.get(planetname);
        Log.v("planet3", planetname);
        image3.setImageResource(planet.get(2));
        return view;
    }
    ...
    public interface OnFragmentThreeInteractionListner {
